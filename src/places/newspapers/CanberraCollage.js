...
import canberraCollage from './images/news/canberra/canberra_coll_art.png'
import canberraCollPic from './images/news/canberra/canberra_coll_pic.png'
import SrcNotes from './images/news/canberra/srcNotes.png'
    ...
    render() {
      ...
      return(
        <div>
          ...
          <MuiThemeProvider>
            <img src={SrcNotes} alt="Canberra Collage Article" />
          </MuiThemeProvider>
